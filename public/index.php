...
$main =
    ...
    <body>
        ...
        <main>
            <div class="container">
                <div class="title">
                    <h1 class="editor">Editeur de carte</h1>
                    <h1 class="card flipped">Carte écrite par Clément</h1>
                </div>
                <div class="content">
                    <div class="form flipped">
                        <span>Prénom</span>
                        <input type="text" placeholder="Maxime">
                        <span>Message</span>
                        <textarea placeholder="Coucou ! Voici des nouvelles..."></textarea>
                        <span>Ville</span>
                        <input type="text" placeholder="Lyon">
                        <button>Créer</button>
                    </div>
                    <div class="recto flipped">
                        <img src="./assets/img/photo.jpg" alt="La belle photo !">
                    </div>
                    <div class="verso">
                        <img src="./assets/img/carteverso.jpg" alt="Verso de la carte.">
                        <span class="message">Tagada tagada</span>
                        <span class="city">Nous pensons à vous depuis <strong>Mulhouse</strong> ;)<br>Actuellement, il fait <strong>11°C</strong>.</span>
                    </div>
                </div>
            </div>
        </main>
